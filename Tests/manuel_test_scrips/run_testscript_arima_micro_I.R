...
test_arima_complete_vectorized_dataset_f_9 <- function() {
  ...
  cat("test_arima_complete_vectorized_dataset_f_9: ERROR: ")
  cat(error)
  cat("\n")
}

test_arima_complete_vectorized_dataset_f_10 <- function() {
  ...
  cat("test_arima_complete_vectorized_dataset_f_10: ERROR: ")
  cat(error)
  cat("\n")
}
